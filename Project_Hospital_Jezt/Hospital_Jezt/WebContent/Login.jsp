        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><small>Sign in with your account !</small></div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-muted mb-2" style="margin-bottom:20px">
              ...
              <form role="form" method="post" action="LoginController">
                <div class="form-group mb-3">
                  ...
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Your acount ..."  type="text" name="user">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Your password ..."  type="password" name="pass">
                  </div>
                </div>
                <hr>
                <div class="text-center">
                
                  <button type="submit"  class="btn btn-primary my-4" name="action">Sign in</button>
                </div>
              </form>
            </div>
          </div>
